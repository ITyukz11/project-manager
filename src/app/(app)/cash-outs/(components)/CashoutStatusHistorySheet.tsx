...
import { CashoutLogs, User } from "@prisma/client";

// log.performedBy is expected, not performedById!
type CashoutLogsWithUser = CashoutLogs & { performedBy?: User };

export function CashoutStatusHistorySheet({
  open,
  onOpenChange,
  data,
}: {
