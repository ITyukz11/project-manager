...
export function CustomerSupportFormDialog({
  open,
  onOpenChange,
  onSubmitted,
}: {
  ...
  async function handleSubmit(values: CustomerSupportFormValues) {
    setLoading(true);
    try {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          <DialogTitle>Request CustomerSupport</DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form
          ...
          >
            ...
            <GlobalFormField
              ...
              label="Details"
              required
              placeholder="Enter customerSupport details"
              type="textarea"
              row={10}
            />
            <GlobalFormField
