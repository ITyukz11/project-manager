...
import { CashinLogs, User } from "@prisma/client";

// log.performedBy is expected, not performedById!
type CashinLogsWithUser = CashinLogs & { performedBy?: User };

export function CashinStatusHistorySheet({
  open,
  onOpenChange,
  data,
}: {
